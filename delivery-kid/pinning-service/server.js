...
const STAGING_DIR = process.env.STAGING_DIR || '/var/lib/pinning-service/staging';
...
const WEBHOOK_BASE_URL = process.env.WEBHOOK_BASE_URL || 'https://pinning.delivery-kid.cryptograss.live';
